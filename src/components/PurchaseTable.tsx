      ...
      <Table>
          <TableHeader className="bg-zinc-950/50">
              <TableRow className="border-zinc-800 hover:bg-transparent">
                ...
                <TableHead className="text-[10px] uppercase font-bold text-zinc-500 tracking-wider h-12 text-center px-6">Notes</TableHead>
            ...
            {filteredPurchases.length === 0 ? (
              ...
              filteredPurchases.map((p) => (
                <TableRow key={p.id} className="border-zinc-800/50 hover:bg-zinc-800/20 transition-colors">
                  ...
                  <TableCell className="text-center text-xs text-zinc-500 max-w-[200px] truncate px-6">
                    {type === 'tiktok_paylater' 
